      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-14 space-y-14">
        <section className="grid lg:grid-cols-[1.9fr_0.9fr] gap-8">
          <div className="rounded-[1.75rem] border border-border bg-card/50 backdrop-blur-sm p-6 md:p-10 shadow-xl">
            <h3 className="text-2xl md:text-3xl font-bold text-foreground font-heading">Join Us</h3>
          ...
          <div className="space-y-8">
            <div className="rounded-[1.75rem] border border-border bg-card/50 backdrop-blur-sm p-6 md:p-8 shadow-xl">
              <h4 className="text-2xl md:text-3xl font-bold text-foreground font-heading">Contact Information</h4>
              ...
              <div className="mt-8 space-y-7">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-muted-foreground mt-1">Da Nang Software Park 2, Nhu Nguyet Street, Hai Chau Ward, Da Nang City</p>
                  </div>
                </div>
        ...
        <section className="grid md:grid-cols-4 gap-8 pt-2">
          <div className="col-span-1 md:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-sm">
              The Future of Fintech Innovation & Sandbox Infrastructure
            </p>
          ...
          <div className="col-span-1 space-y-4">
            <h4 className="font-bold text-base text-foreground">Products</h4>
            <ul className="space-y-2 text-muted-foreground text-base">
              ...
              <li><Link href="/accelerator" className="hover:text-primary transition-colors">Funding</Link></li>
            </ul>
          </div>

          <div className="col-span-1 space-y-4">
            <h4 className="font-bold text-base text-foreground">Company</h4>
            <ul className="space-y-2 text-muted-foreground text-base">
              <li><Link href="/about" className="hover:text-primary transition-colors">About DFL24</Link></li>
