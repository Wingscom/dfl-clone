...
const content = {
  heroLead: { en: 'Backed by Global', vi: 'Được hậu thuẫn bởi' },
  heroHighlight: {
    en: 'World Class Innovators',
    vi: 'Những nhà đổi mới đẳng cấp thế giới',
  },
  heroSubtitle: {
    en: "Our network of strategic partners connects Da Nang's innovators with world-class capital, expertise, and global market access.",
    vi: 'Mạng lưới đối tác chiến lược của chúng tôi kết nối các nhà đổi mới tại Đà Nẵng với nguồn vốn, chuyên môn và thị trường toàn cầu đẳng cấp thế giới.',
  },
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-32 pb-20 space-y-32">
        ...
        <div className="space-y-12">
          <div className="flex items-end justify-between border-b border-black/5 dark:border-white/5 pb-4">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground font-heading">{t(content.partners)}</h2>
          </div>
