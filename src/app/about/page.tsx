    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 pt-40 pb-20 space-y-32">
      ...
      <div className="text-center space-y-6 max-w-4xl mx-auto fade-in-up">
        ...
        <p className="text-xl md:text-2xl font-medium text-muted-foreground">
          Where innovation meets sovereignty. Where every district becomes a
      ...
      <div id="dfl" className="space-y-8 scroll-mt-32">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-md hover:bg-card/50 transition-colors group">
            ...
            <p className="text-muted-foreground">
              Pioneering the intersection of financial services and artificial
              intelligence.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group relative p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 min-h-75 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-muted-foreground">
                A strategic leader driving innovation and investment between
                Europe and Asia. Based in France and Vietnam, she serves as
                President of VYBE, Partner at Da Nang International Financial
                Center, and VINEU Director of France
              </p>
            </div>
          </div>
          ...
          <div className="group relative p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 min-h-75 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              <div className="w-20 h-20 rounded-full mb-6 overflow-hidden border-2 border-black/5 dark:border-white/10 relative">
                <Image
                  src="/assets/img/kiel_digiovanni.png"
                  alt="Kiel DiGiovanni"
                  fill
                  className="w-full h-full object-cover"
                />
              ...
              <p className="text-lg text-muted-foreground">
                Previously acted as COO of Expand and Motus Operandi, supporting
                business growth and China market expansion. He also co-founded
                SET FOR SET, an e-commerce fitness startup successfully sold in
                2024.
              </p>
            </div>
          </div>
          ...
          <div className="group relative p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 min-h-75 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              <div className="w-20 h-20 rounded-full mb-6 overflow-hidden border-2 border-black/5 dark:border-white/10 relative">
                <Image
                  src="/assets/img/vincenzo_cartelli.png"
                  alt="Vincenzo Cartelli"
                  fill
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <p className="text-lg text-muted-foreground">
                CTO at Expand and CrossFund, with over 20 years of experience in
                enterprise architecture, blockchain, and AI. He also serves as a
                Research Collaborator at the University of Catania, bridging
                academic innovation with scalable commercial applications.
              </p>
            </div>
          </div>
          ...
          <div className="group relative p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 min-h-75 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              <div className="w-20 h-20 rounded-full mb-6 overflow-hidden border-2 border-black/5 dark:border-white/10 relative">
                <Image
                  src="/assets/img/nikhil_porwal.png"
                  alt="Nikhil Porwal"
                  fill
                  className="w-full h-full object-cover"
                />
              ...
              <p className="text-lg text-muted-foreground">
                A finance executive with over a decade of experience across
                APAC, including CFO-level roles overseeing operations in Hong
                Kong, Singapore, Indonesia, India, and China. Chartered
                Accountant (India) and CPA Australia.
              </p>
            </div>
          </div>
          ...
          <div className="group relative p-10 rounded-[2.5rem] border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 min-h-75 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-muted-foreground">
                Founder of Yuusoft, based in Singapore, he brings over a decade
                of experience in software development and leading engineering
                teams at startups including Xendit, Leyan Technologies, and
                edugo.ai.
              </p>
            </div>
          </div>
      ...
      <div id="danang" className="space-y-8 scroll-mt-32">
        <div className="group relative rounded-[2.5rem] overflow-hidden border border-white/5 bg-card/50 backdrop-blur-sm shadow-2xl">
          <div className="grid md:grid-cols-2 gap-0 min-h-125">
            ...
            <div className="p-12 md:p-16 flex flex-col justify-center space-y-6 relative z-10">
              ...
              <p className="text-lg leading-relaxed font-medium text-muted-foreground">
                Known for its stunning coastline and high quality of life, Da
                Nang is rapidly transforming into Vietnam&apos;s premier hub for
                technology and innovation. With a strategic location, modern
                infrastructure, and a forward-thinking government, the city
                attracts top talent and investment from across the globe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-card/30 backdrop-blur-md hover:bg-card/50 transition-colors group">
            ...
            <p className="text-muted-foreground">
              Access to a vibrant talent pool from top universities and
        ...
        <div className="relative group/carousel">
          <div
            ...
            className="w-full overflow-x-auto flex snap-x snap-mandatory gap-6 pb-6 -mx-4 px-4 md:mx-0 md:px-0 hide-scrollbar scroll-smooth"
          >
            ...
            <div className="snap-center shrink-0 w-[85%] md:w-[60%] relative rounded-3xl overflow-hidden border border-black/5 dark:border-white/5 shadow-xl group">
              <div className="aspect-video relative">
                <Image
                  src="/assets/img/danang-masterplan-2.png"
                  alt="Da Nang Masterplan 2"
                  fill
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                />
              </div>
            ...
            <div className="snap-center shrink-0 w-[85%] md:w-[60%] relative rounded-3xl overflow-hidden border border-black/5 dark:border-white/5 shadow-xl group">
              <div className="aspect-video relative">
                <Image
                  src="/assets/img/dragon-bridge-danang.jpg"
          ...
          <button
            onClick={() => scroll("left")}
            id="prev-slide"
            className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-black/50 hover:bg-black/70 backdrop-blur-md flex items-center justify-center text-white transition-all opacity-0 group-hover/carousel:opacity-100 md:-left-6 shadow-lg border border-white/10"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          <button
            ...
            id="next-slide"
            className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-black/50 hover:bg-black/70 backdrop-blur-md flex items-center justify-center text-white transition-all opacity-0 group-hover/carousel:opacity-100 md:-right-6 shadow-lg border border-white/10"
          >
            <svg
              className="w-6 h-6"
              fill="none"
        ...
        <div className="pt-16 pb-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Da Nang: The Central Hub connecting North and South
            </p>
          </div>

          <div className="relative w-full max-w-[320px] mx-auto mt-8">
            <Image
              src="/assets/img/vndanangmap.png"
              alt="Vietnam Map highlighting Da Nang"
              width={320}
              height={640}
        ...
        <div className="group relative rounded-[2.5rem] overflow-hidden border border-white/5 bg-card/50 backdrop-blur-sm shadow-2xl">
          <div className="grid md:grid-cols-2 gap-0 min-h-125">
            <div className="p-12 md:p-16 flex flex-col justify-center space-y-6 relative z-10 order-2 md:order-1">
              ...
              <p className="text-lg leading-relaxed font-medium text-muted-foreground">
                The VIFC is a policy sandbox and economic zone designed to rival
                global financial hubs. It offers regulatory flexibility, tax
                incentives, and a world-class environment for financial
                institutions, fintech startups, and venture capital firms to
      ...
      <div className="text-center space-y-8 py-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Whether you are a startup looking to accelerate, an investor seeking
          opportunities, or an institution ready to innovate, DFL is your
          partner in Da Nang.
        </p>
        <Link
          href="/contact"
